# js-instruments
# Overview
This repo is for some volunteer workshops with Girls Rock Charlotte to teach how to code a playable instrument. Each project will have a set of starting files and a set of finished files. 
## Drum Kit
